...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT = 872;
	#define RC_FILEVERSION 0,0,4,193
	#define RC_FILEVERSION_STRING "0, 0, 4, 193\0"
	static const char FULLVERSION_STRING[] = "0.0.4.193";

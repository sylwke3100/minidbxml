...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT = 983;
	#define RC_FILEVERSION 0,0,60,467
	#define RC_FILEVERSION_STRING "0, 0, 60, 467\0"
	static const char FULLVERSION_STRING[] = "0.0.60.467";

...
namespace AutoVersion{
	...
	static const long REVISION = 2682;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT = 1718;
	#define RC_FILEVERSION 0,0,462,2682
	#define RC_FILEVERSION_STRING "0, 0, 462, 2682\0"
	static const char FULLVERSION_STRING[] = "0.0.462.2682";
